...
@when('charm.tf-job-operator.started')
def charm_ready():
    layer.status.active('')
...
def update_image():
    clear_flag('charm.tf-job-operator.started')


@when('layer.docker-resource.oci-image.available')
@when_not('charm.tf-job-operator.started')
def start_charm():
    ...
    set_flag('charm.tf-job-operator.started')
